...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.mcloud.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".mcloud" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".mcloud")
	}
